...
/**
 * Реализовать класс для работы с одномерными динамическими массивами произвольных данных(произвольного типа). Класс
 * будет иметь следующие конструкторы:
...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayHandler arrayHandler = new ArrayHandler(list);
