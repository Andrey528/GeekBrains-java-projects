package JavaExceptionsCurse.hw3;
...
import JavaExceptionsCurse.hw3.presenters.ConfigPresenter;
 ...
 * бросить исключение, соответствующее типу проблемы. Можно использовать встроенные типы java и создать свои. Исключение должно быть
...
public class Main {
    public static void main(String[] args) {
        ConfigPresenter presenter = new ConfigPresenter();
