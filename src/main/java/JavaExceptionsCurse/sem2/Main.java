package JavaExceptionsCurse.sem2;
...
public class Main {
    ...
    static int proccessArrayInternal(String[][] arr) throws  MyArraySizeException, MyArrayDataException {
